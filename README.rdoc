...
Create new session :
  ...
  Arguments (Mixed) :
    ...
    (as a Hash) :
        :description    =>  (Optional) (String) Description for meeting
        :tags           =>  (Optional) (String) Tags associated with meeting
  ...
  Return value :
    ...
    :userPassword   (String) (Optional) Returns in case if user what created meeting is new user in the system
...
Schedule a session :
  ...
  Arguments (as a Hash) :
    ...
    :startTime      =>  (Required) (Number(DateTime in seconds) or DateTime)
    :endTime        =>  (Required) (Number(DateTime in seconds) or DateTime)
